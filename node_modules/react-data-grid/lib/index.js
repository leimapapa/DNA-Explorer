...
const rowClassname = `rdg-row rdg-7-0-0-beta-60-3c083f1b`;
const topSummaryRowClassname = "rdg-top-summary-row";
const bottomSummaryRowClassname = "rdg-bottom-summary-row";
const headerRowClassname = `rdg-header-row rdg-7-0-0-beta-60-0dbd5994`;
...
const arrowClassname = `rdg-sort-arrow rdg-7-0-0-beta-60-3d5115f3`;
...
const rootClassname = `rdg rdg-7-0-0-beta-60-ccd2e5d9`;
const viewportDraggingClassname = `rdg-viewport-dragging rdg-7-0-0-beta-60-e9b0e1c9`;
const frozenColumnShadowClassname = "rdg-7-0-0-beta-60-2e639f12";
const frozenColumnShadowStartOverrides = "rdg-7-0-0-beta-60-86aef152";
const frozenColumnShadowEndOverrides = "rdg-7-0-0-beta-60-7689f238";
const frozenColumnShadowStartClassname = `${frozenColumnShadowClassname} ${frozenColumnShadowStartOverrides}`;
const frozenColumnShadowEndClassname = `${frozenColumnShadowClassname} ${frozenColumnShadowEndOverrides}`;
const topShadowClassname = "rdg-7-0-0-beta-60-487ac462";
const frozenColumnShadowStartTopClassname = `${frozenColumnShadowStartClassname} ${topShadowClassname}`;
const frozenColumnShadowEndTopClassname = `${frozenColumnShadowEndClassname} ${topShadowClassname}`;
//#endregion
...
const summaryRowClassname = `rdg-summary-row rdg-7-0-0-beta-60-0b90c82c`;
...
function DataGrid(props) {
	...
	*/
	...
	const { columns, colSpanColumns, lastStartFrozenColumnIndex, firstEndFrozenColumnIndex, headerRowsCount, colOverscanStartIdx, colOverscanEndIdx, templateColumns, layoutCssVars, totalStartFrozenColumnWidth, totalEndFrozenColumnWidth } = useCalculatedColumns({
		rawColumns,
	...
	*/
	useImperativeHandle(ref, () => ({
		...
		scrollToCell({ idx, rowIdx }) {
			const scrollToIdx = idx != null && idx > lastStartFrozenColumnIndex && (firstEndFrozenColumnIndex === -1 || idx < firstEndFrozenColumnIndex) && idx < columns.length ? idx : void 0;
	...
	*/
	...
	function handleKeyDown(event) {
		...
		if (!(target.closest(".rdg-cell") !== null) && !(isTreeGrid && target.role === "row")) return;
		switch (event.key) {
			case "ArrowUp":
			case "ArrowDown":
			case "ArrowLeft":
	...
	function renderFrozenShadow(shadowStyles, bodyClassname, topClassname) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			lastStartFrozenColumnIndex > -1 && renderFrozenShadow(frozenStartShadowStyles, frozenColumnShadowStartClassname, frozenColumnShadowStartTopClassname),
			firstEndFrozenColumnIndex > -1 && renderFrozenShadow(frozenEndShadowStyles, frozenColumnShadowEndClassname, frozenColumnShadowEndTopClassname),
			getDragHandle(),
...
const groupRowClassname = `rdg-group-row rdg-7-0-0-beta-60-e74a2be3`;
...
const textEditorClassname = `rdg-text-editor rdg-7-0-0-beta-60-2f8db206`;
