 ...
 */
declare function DataGrid<R, SR = unknown, K extends Key = Key>(props: DataGridProps<R, SR, K>): import("react").JSX.Element;
//#endregion
...
declare function renderCheckbox({ onChange, indeterminate, ...props }: RenderCheckboxProps): import("react").JSX.Element;
//#endregion
//#region src/cellRenderers/renderToggleGroup.d.ts
declare function renderToggleGroup<R, SR>(props: RenderGroupCellProps<R, SR>): import("react").JSX.Element;
declare function ToggleGroup<R, SR>({ groupKey, isExpanded, tabIndex, toggleGroup }: RenderGroupCellProps<R, SR>): import("react").JSX.Element;
//#endregion
