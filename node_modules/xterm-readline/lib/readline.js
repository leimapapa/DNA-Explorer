...
class Readline {
    ...
    activate(term) {
        ...
        this.disposables.push(this.term.onResize(({ cols, rows }) => {
            ...
            tty.col = cols;
            tty.row = rows;
            if (tty.anchorRow >= rows)
                tty.anchorRow = Math.max(0, rows - 1);
    ...
    tty() {
        ...
        if (((_b = (_a = this.term) === null || _a === void 0 ? void 0 : _a.options) === null || _b === void 0 ? void 0 : _b.tabStopWidth) !== undefined) {
            ...
            return new tty_1.Tty(this.term.cols, this.term.rows, this.term.options.tabStopWidth, this.output(), anchor);
        }
        else {
